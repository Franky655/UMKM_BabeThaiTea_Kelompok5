...
<head>
    ...
    <!-- PROMO -->
    <div class="promo bg-light py-5">
        <div class="container">
            <div class="title-container">
                <h2 class="text-center fw-bold">OUR PROMO</h2>
            </div>
            <p class="text-center mt-4">Selain Itu kami Menyediakan Beberapa Promo Menarik Setiap harinya :D</p>
            <div class="row mt-5">
